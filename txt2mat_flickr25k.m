...
str = '.\Results\flickr\';
str1 = '.\Results\flickr\ucmh_flickr_i2t';
str2 = '.\Results\flickr\ucmh_flickr_t2i';

% recallbits=[1:100:18015];
% 
% num_bits = 1;
% 
...
%     [ucmh_map(1,i),ucmh_precision(:,i),ucmh_recall(:,i)] = evaluation_flickr(hamm,qLabel,bLabel,recallbits);
%    
% end

map_dir=[str1,'_map.mat'];
save(map_dir,'ucmh_map');
precision_dir=[str1,'_precision.mat'];
save(precision_dir,'ucmh_precision');
recall_dir=[str1,'_recall.mat'];
save(recall_dir,'ucmh_recall');
